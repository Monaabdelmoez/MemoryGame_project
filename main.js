...
document.querySelector(".control-buttons .gamelevel").onclick = function () {
  ...
  if (document.getElementsByClassName("test1").length == 0) {
    ...
    medium.innerHTML = "medium level";
    medium.classList.add("test1", "medium");
    sis.appendChild(medium);
    let hight = document.createElement("div");
    hight.innerHTML = "high level";
...
function makeclickongamelevel() { 
  ...
  document
    .querySelector(".control-buttons .span .test .medium")
    .addEventListener("click", function () {
      console.log("you select easy medium");
      bolcknumber = 12;
      makeblock("medium");
    });
